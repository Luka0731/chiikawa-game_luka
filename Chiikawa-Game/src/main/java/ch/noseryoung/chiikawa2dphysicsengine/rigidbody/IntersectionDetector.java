...
public class IntersectionDetector {
    ...
    public static boolean isPointOnLine(Vector2f point, Line line) {
        ...
        if (ChiikawaMath.compare(dx, 0f)) return ChiikawaMath.compare(point.x, line.getFromPosition().x);

        float slob = dy / dx;
        float yIntersect = line.getToPosition().y - (slob * line.getToPosition().x);
        return ChiikawaMath.compare(point.y, slob * point.x + yIntersect);
    }
    ...
    public static boolean doesLineIntersectRectangle(Line line, Rectangle rectangle) {
        ...
        ChiikawaMath.rotate(localStart, theta, center);
    ...
    public static boolean raycast(Rectangle rectangle, Ray ray, RaycastResult result) {
        ...
        ChiikawaMath.rotate(xAxis, rectangle.getRigidbody().getRotation(), new Vector2f(0, 0));
        ChiikawaMath.rotate(yAxis, rectangle.getRigidbody().getRotation(), new Vector2f(0, 0));
        ...
        for (int i = 0; i < 2; i++) {
            if (ChiikawaMath.compare(f.get(i), 0)) {
    ...
    public static boolean doesCircleIntersectRectangle(Circle circle, Rectangle rectangle) {
        ...
        ChiikawaMath.rotate(r, -rectangle.getRigidbody().getRotation(), new Vector2f(0, 0));
    ...
    public static boolean doesAABRIntersectRectangle(AABR aabr, Rectangle rectangle) {
        ...
        ChiikawaMath.rotate(axisToTest[2], aabr.getRigidbody().getRotation(), new Vector2f(0, 0));
        ChiikawaMath.rotate(axisToTest[3], aabr.getRigidbody().getRotation(), new Vector2f(0, 0));
        for (int i = 0; i < axisToTest.length; i++) {
